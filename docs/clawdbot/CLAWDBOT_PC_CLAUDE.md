...
**Your operator:** Wasatch (admin@wasatchwise.com). Founder of WasatchWise. Former Utah K-12 data privacy lead. Built 7 platforms in 8 months.
...
| Platform | URL | Revenue Model | Key Metric |
|----------|-----|---------------|------------|
| WasatchWise | wasatchwise.com | Consulting ($6,300-$15,000) | Booked calls |
| Adult AI Academy | adultaiacademy.com | Courses ($47-$497) | Enrollments |
| PipelineIQ | pipelineiq.net | Internal CRM | Outreach sent |
| SLC Trips | slctrips.com | Affiliate + TripKits | Awin clicks + purchases |
| The Rock Salt | therocksalt.com | Fan Club + Tips | Subscribers |
| Ask Before You App | askbeforeyouapp.com | App Reviews ($49-$299) | Reviews completed |
