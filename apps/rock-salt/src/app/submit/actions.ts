      ...
      embeds: [
        {
          ...
          description: `**${bandName}** has submitted music for review.`,
          color: 0x5865F2, // Discord Blurple
          fields: [
            { name: 'Contact', value: `${contactName} (${contactEmail})`, inline: true },
            { name: 'Hometown', value: hometown, inline: true },
            { name: 'Primary Genre', value: primaryGenre, inline: true },
            { name: 'Admin Link', value: `${process.env.NEXT_PUBLIC_SITE_URL || 'http://localhost:3000'}/admin/music-submissions` }
          ],
