      ...
      embeds: [
        {
          ...
          description: `**${eventName}** at **${finalVenueName}** has been submitted.`,
          color: 0x34A853, // Google Green
          fields: [
            { name: 'Organizer', value: `${organizerName} (${organizerEmail})`, inline: true },
            { name: 'Date/Time', value: new Date(startTime).toLocaleString(), inline: true },
            { name: 'Admin Link', value: `${process.env.NEXT_PUBLIC_SITE_URL || 'http://localhost:3000'}/admin` }
          ],
