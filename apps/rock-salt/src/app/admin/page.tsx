      ...
      <div className="min-h-screen bg-white text-black p-8">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex gap-4">
            <Link href="/admin/music-submissions" className="px-4 py-2 bg-purple-500 text-white rounded hover:bg-purple-600">
              Music Submissions
            </Link>
            ...
            <Link href="/admin/spider-manual" className="px-4 py-2 bg-slate-800 text-white rounded hover:bg-slate-900">
              🕷️ Spider Manual
            </Link>
          </div>
        </div>
