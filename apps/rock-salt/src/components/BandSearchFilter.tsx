  ...
  return (
    <div>
      ...
      <div className="mb-8 bg-white dark:bg-gray-800 rounded-xl shadow-lg border-2 border-gray-200 dark:border-gray-700 p-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="relative">
            ...
            <select
              ...
              className="w-full pl-12 pr-10 py-3 bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-yellow-400 focus:border-transparent text-gray-900 dark:text-white cursor-pointer"
        ...
        {/* Results count */}
        <div id="search-results" className="mt-4 text-sm text-gray-600 dark:text-gray-400" aria-live="polite">
