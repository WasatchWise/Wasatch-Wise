...
interface UploadVenuePhotoFormProps {
  venueId: string
}

export default function UploadVenuePhotoForm({ venueId }: UploadVenuePhotoFormProps) {
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              required
              className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent dark:bg-gray-700 dark:text-white file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:bg-amber-50 dark:file:bg-amber-900 file:text-amber-700 dark:file:text-amber-300 file:font-medium hover:file:bg-amber-100 dark:hover:file:bg-amber-800"
            />
            {file && (
          ...
          <div className="flex items-center gap-2">
            ...
            <label htmlFor="is-primary" className="text-sm font-medium text-gray-700 dark:text-gray-300">
              Set as primary photo (displayed on venue page header)
            </label>
          </div>
