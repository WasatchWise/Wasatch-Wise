      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid md:grid-cols-3 gap-6 sm:gap-8 mb-8 sm:mb-12">
          <div className="border-l-4 border-orange-500 pl-4 sm:pl-6">
            <h3 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3">Weeks 1-4: Governance</h3>
          ...
          <div className="border-l-4 border-orange-500 pl-4 sm:pl-6">
            <h3 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3">Weeks 5-8: Deep Literacy</h3>
            <p className="text-sm sm:text-base text-gray-700 mb-3 sm:mb-4 leading-relaxed">
          ...
          <div className="border-l-4 border-orange-500 pl-4 sm:pl-6">
            <h3 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3">Weeks 9-12: Trust + Verification</h3>
            <p className="text-sm sm:text-base text-gray-700 mb-3 sm:mb-4 leading-relaxed">
